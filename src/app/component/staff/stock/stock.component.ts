    ...
    <html>
      <head>
        ...
        <style>
          ...
          .promo-price { color: red; } /* In đỏ nếu có khuyến mãi hoặc giá thấp hơn basePrice */
          .barcode img { width: 250px; height: auto; }
        </style>
      </head>
      <body>
        <div class="tag-container">
          ...
          <p class="price ${priceClass}">
            <strong>Giá:</strong> ${stock.salePrice.toLocaleString()} VND
          </p>
          <div class="barcode">
